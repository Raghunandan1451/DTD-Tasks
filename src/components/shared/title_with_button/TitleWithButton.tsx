...
const TitleWithButton: React.FC<TitleWithButtonProps> = (props) => {
	...
	return (
		<div
			className={`flex place-content-between place-items-center p-2 rounded-tl-xl bg-white/10 dark:bg-gray-900/20 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-lg text-black dark:text-white ${containerClass}`}
		>
