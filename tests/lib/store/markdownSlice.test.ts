...
describe("markdownSlice", () => {
	...
	it("should select a file and load its content", () => {
		const file: File = { path: "notes.txt", type: "file", content: "abc" };
		const stateWithFile: FileState = { ...initialState, files: [file] };
